...
export default function Footer() {
  ...
  const getLinkClasses = (path: string) => {
    const baseClasses = "inline-block text-neutral-600 hover:text-neutral-900 transition-all duration-300 ease-out cursor-none";
            ...
            <nav className="flex flex-col space-y-2">
              <div>
                <a 
                  ...
                  className="inline-block text-neutral-600 hover:text-neutral-900 transition-all duration-300 ease-out cursor-none transform hover:translate-x-2"
                >
                  LinkedIn
                </a>
              </div>
