...
export default function BackgroundDropdown() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto mt-8">
      ...
      >
        <span className="text-xl font-semibold text-gray-500 tracking-widest uppercase">/ Background</span>
      ...
      >
        <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl shadow p-6 min-h-[80px] flex flex-col justify-center">
          ...
          <span className="text-gray-700 text-base">I grew up in Port Townsend, WA and didn&#39;t know what UI meant until 2024. I&#39;ve learned a lot since then, and intend to continue. My favorite ways to learn are traveling, reading, and trying.</span>
        </div>
      </div>
    </div>
  );
